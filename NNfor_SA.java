...
public class NNfor_SA {
    ...
    public static void main(String[] args) {
        ...
        oa[0] = new SimulatedAnnealing(1e3, .6, nnop[0]); // change SA parameters
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                write_output_to_file("Optimization_Results", "heart_results_SA_p06.csv", final_result, true);
