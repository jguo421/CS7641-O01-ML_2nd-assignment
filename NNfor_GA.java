...
public class NNfor_GA {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 222); 
    ...
    public static void main(String[] args) {
       ...
       // oa[0] = new SimulatedAnnealing(1e3, .9, nnop[0]); // change SA parameters
         oa[0] = new StandardGeneticAlgorithm(75, 25, 2, nnop[0]);
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                write_output_to_file("Optimization_Results", "heart_results_GA_5.csv", final_result, true);
