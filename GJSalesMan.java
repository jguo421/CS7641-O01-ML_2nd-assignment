...
public class GJSalesMan {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	FileWriter writer_rhc = new FileWriter("travelling_rhc.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_sa = new FileWriter("travelling_sa.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_ga = new FileWriter("travelling_ga.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_mimic = new FileWriter("travelling_mimic.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_rhc_time = new FileWriter("travelling_rhc_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_sa_time = new FileWriter("travelling_sa_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_ga_time = new FileWriter("travelling_ga_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_mimic_time = new FileWriter("travelling_mimic_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	/////////////////////////////////////////////////////////////////////
    	int sample_N[] = {10,20,30,40,50,100};
    ...
    //	int tot_run = 5;
    	...
    	FileWriter writer_rhc_n = new FileWriter("travelling_rhc_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_sa_n = new FileWriter("travelling_sa_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_ga_n = new FileWriter("travelling_ga_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_mimic_n = new FileWriter("travelling_mimic_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_rhc_time_n = new FileWriter("travelling_rhc_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_sa_time_n = new FileWriter("travelling_sa_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_ga_time_n = new FileWriter("travelling_ga_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_mimic_time_n = new FileWriter("travelling_mimic_time_n.csv");
    	for (int j=0; j<LL; j++) {
