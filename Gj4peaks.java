...
public class Gj4peaks {
    ...
    public static <StringWriter, CSVWriter> void main(String[] args) throws IOException {
    		...
    		
    	{
    		...
    		// System.out.print(list_rhc_eval[iter]);
    	...
    	FileWriter writer_rhc = new FileWriter("4_peaks_rhc.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_sa = new FileWriter("4_peaks_sa.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_ga = new FileWriter("4_peaks_ga.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_mimic = new FileWriter("4_peaks_mimic.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_rhc_time = new FileWriter("4_peaks_rhc_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_sa_time = new FileWriter("4_peaks_sa_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_ga_time = new FileWriter("4_peaks_ga_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	FileWriter writer_mimic_time = new FileWriter("4_peaks_mimic_time.csv");
    	for (int j=0; j<L; j++) {
    	...
    	/////////////////////////////////////////////////////////////
   // 	int iterations[] = {50, 100, 200, 300, 500, 1000, 2000, 3000, 5000};
    	int sample_N[] = {50,100,200,300,400,500,600,700,800,900,1000};
    ...
    //	int tot_run = 5;
    	...
    	FileWriter writer_rhc_n = new FileWriter("4_peaks_rhc_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_sa_n = new FileWriter("4_peaks_sa_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_ga_n = new FileWriter("4_peaks_ga_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_mimic_n = new FileWriter("4_peaks_mimic_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_rhc_time_n = new FileWriter("4_peaks_rhc_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_sa_time_n = new FileWriter("4_peaks_sa_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_ga_time_n = new FileWriter("4_peaks_ga_time_n.csv");
    	for (int j=0; j<LL; j++) {
    	...
    	FileWriter writer_mimic_time_n = new FileWriter("4_peaks_mimic_time_n.csv");
    	for (int j=0; j<LL; j++) {
